        ...
        void RenderGBuffer(CullResults cull, Camera camera, ScriptableRenderContext renderContext, CommandBuffer cmd)
        {
            ...
            using (new ProfilingSample(m_CurrentDebugDisplaySettings.IsDebugDisplayEnabled() ? "GBufferDebugDisplay" : "GBuffer", cmd))
            {
                ...
                if (m_CurrentDebugDisplaySettings.IsDebugDisplayEnabled())
                {
                    ...
                    RenderOpaqueRenderList(cull, camera, renderContext, cmd, HDShaderPassNames.m_GBufferDebugDisplayName, HDUtils.GetRendererConfigurationBakedLighting(), RenderQueueRange.opaque, m_DepthStateOpaque);
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        RenderOpaqueRenderList(cull, camera, renderContext, cmd, HDShaderPassNames.m_GBufferName, HDUtils.GetRendererConfigurationBakedLighting(), RenderQueueRange.opaque, m_DepthStateOpaque);
                    }
                }
            }
        }
        ...
        void RenderDebugViewMaterial(CullResults cull, HDCamera hdCamera, ScriptableRenderContext renderContext, CommandBuffer cmd)
        {
            using (new ProfilingSample("DisplayDebug ViewMaterial", cmd))
            {
                ...
                else
                {
                    ...
                    RenderOpaqueRenderList(cull, hdCamera.camera, renderContext, cmd, HDShaderPassNames.m_ForwardDisplayDebugName, HDUtils.GetRendererConfigurationBakedLighting());

                    // Render forward transparent
                    RenderTransparentRenderList(cull, hdCamera.camera, renderContext, cmd, HDShaderPassNames.m_ForwardDisplayDebugName, HDUtils.GetRendererConfigurationBakedLighting());
                }
            }
        ...
        void RenderForward(CullResults cullResults, Camera camera, ScriptableRenderContext renderContext, CommandBuffer cmd, bool renderOpaque)
        {
            ...
            using (new ProfilingSample(profileName, cmd))
            {
                ...
                if (renderOpaque)
                {
                    ...
                    RenderOpaqueRenderList(cullResults, camera, renderContext, cmd, arrayNames, HDUtils.GetRendererConfigurationBakedLighting(), null, m_DepthStateOpaqueWithPrepass);
                }
                else
                {
                    RenderTransparentRenderList(cullResults, camera, renderContext, cmd, arrayNames, HDUtils.GetRendererConfigurationBakedLighting());
                }
            }
        }
